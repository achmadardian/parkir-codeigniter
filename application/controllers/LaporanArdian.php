...
class LaporanArdian extends CI_Controller
{
    ...
    public function tanggalArdian()
    {
        ...
        $ardian['user'] = $this->db->get_where('admin', ['username' =>
    ...
    public function parkirExcel()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ->setCellValue('D1', 'LAPORAN PARKIR MERCU BUANA')
            ->setCellValue('A3', 'No')
        ...
        header('Content-Disposition: attachment;filename="Laporan Parkir Mercu Buana.xlsx"');
